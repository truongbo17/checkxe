...
return [
    ...
    */
    ...
    'registration_open' => env('BO_REGISTRATION_OPEN', env('APP_ENV') === 'local'),
    ...
    */
    ...
    // You can make sure all your URLs use this prefix by using the bo_url() helper instead of url()
    'route_prefix' => 'admin',
    ...
    */
    ...
    'password_recovery_throttle_notifications' => 300, // time in seconds
    ...
    */
    ...
    'middleware_class' => [
        \Bo\Base\Http\Middleware\CheckIfAdmin::class,
        \Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull::class,
        \Bo\Base\Http\Middleware\UseBoAuthGuardInsteadOfDefaultAuthGuard::class,
    ],

    // Alias for that middleware
    'middleware_key' => 'admin',
    // Note: It's recommended to use the bo_middleware() helper everywhere, which pulls this key for you.
    ...
    // The password reset configuration for bo.
    ...
    */
    ...
    // if it exists, otherwise it will load it from the default namespace ("bo::").
    ...
    'component_view_namespaces' => [
        'widgets' => [
            'bo::widgets', // falls back to 'resources/views/vendor/backpack/base/widgets'
        ],
    ],
    ...
    */
    ...
    // Bo\Base sets up its own filesystem disk, just like you would by
    // adding an entry to your config/filesystems.php. It points to the root
    // of your project and it's used throughout all Bo packages.
    //
