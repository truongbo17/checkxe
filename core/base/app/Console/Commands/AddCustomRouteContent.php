...
class AddCustomRouteContent extends Command
{
     ...
     * @var string
     */
    protected $signature = 'bo:dashboard:add-custom-route
     ...
     * @var string
     */
    protected $description = 'Add HTML/PHP code to the core/base/routes/bo/custom.php file';
    ...
    public function handle()
    {
        ...
        $disk_name = config('bo.base.core_disk_name');
        ...
        if ($disk->exists($path)) {
            ...
            Artisan::call('vendor:publish', ['--provider' => 'Bo\Base\Providers\BoServiceProvider', '--tag' => 'custom_routes']);
