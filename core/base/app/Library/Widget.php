...
namespace Bo\Base\Library;

use Illuminate\Support\Fluent;

/**
 * Adds fluent syntax to BoCMS Widgets.
 */
class Widget extends Fluent
{
     ...
     * - fallback view paths as configured in core/base/config/base.php.
     *
     * @return array
     */
    public function getFinalViewPath()
    {
        ...
        $paths = array_map(function ($item) use ($type) {
            return $item.'.'.$type;
        }, app('crud')->getViewNamespacesWithFallbackFor('widgets', 'bo.base.component_view_namespaces.widgets'));
