...
trait Views
{
    ...
    {
        return $this->get('create.contentClass') ?? config('bo.crud.operations.create.contentClass', 'col-md-8 bold-labels');
    }
    ...
    {
        return $this->get('list.contentClass') ?? config('bo.crud.operations.list.contentClass', 'col-md-12');
    }
    ...
    {
        return $this->get('show.contentClass') ?? config('bo.crud.operations.show.contentClass', 'col-md-8 col-md-offset-2');
    }
    ...
    {
        return $this->get('update.contentClass') ?? config('bo.crud.operations.update.contentClass', 'col-md-8 bold-labels');
    }
    ...
    {
        return $this->get('reorder.contentClass') ?? config('bo.crud.operations.reorder.contentClass', 'col-md-8 col-md-offset-2');
    }
     ...
     * configured in bo.crud.view_namespaces.fields.
     *
