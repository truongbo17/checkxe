    ...
    */
    ...
    public function applySearchLogicForColumn($query, $column, $searchTerm)
    {
        ...
        if ($column['tableColumn']) {
            $searchOperator = config('bo.operations.list.searchOperator', 'like');
    ...
    public function getResponsiveTable()
    {
        ...
        return config('bo.crud.operations.list.responsiveTable');
    }
    ...
    public function getPersistentTable()
    {
        ...
        return config('bo.crud.operations.list.persistentTable');
    }
    ...
    public function getPersistentTableDuration()
    {
        ...
        return config('bo.crud.operations.list.persistentTableDuration', false);
    }
