...
namespace Bo\Base\Library\Auth;

use Bo\Base\Notifications\ResetPasswordNotification;
use Closure;
 ...
 * a custom notification for BoCMS admins, not the default password reset notification.
 */
class PasswordBroker extends OriginalPasswordBroker
{
    public const RESET_THROTTLED = 'bo::base.throttled';
