    ...
    @if (config('bo.base.meta_robots_content'))<meta name="robots" content="{{ config('bo.base.meta_robots_content', 'noindex, nofollow') }}"> @endif

    <meta name="csrf-token" content="{{ csrf_token() }}" /> {{-- Encrypted CSRF token for Laravel, in order for Ajax requests to work --}}
    <title>{{ isset($title) ? $title.' :: '.config('bo.base.project_name') : config('bo.base.project_name') }}</title>
