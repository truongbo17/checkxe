    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
                ...
                <div class="card-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('bo.auth.login') }}">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="{{ $username }}">{{ config('bo.base.authentication_column_name') }}</label>
            ...
            @if (config('bo.base.registration_open'))
                <div class="text-center"><a href="{{ route('bo.auth.register') }}">{{ trans('bo::base.register') }}</a></div>
            @endif
        </div>
    </div>
@endsection
