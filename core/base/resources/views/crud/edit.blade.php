...
@section('header')
	<section class="container-fluid">
	  <h2>
        ...
        <small>{!! $crud->getSubheading() ?? trans('bo::crud.edit').' '.$crud->entity_name !!}.</small>
		  ...
		  {!! method_field('PUT') !!}
		    ...
		    @endif
		      ...
		      @if(view()->exists('vendor.bo.crud.form_content'))
		      	@include('vendor.bo.crud.form_content', ['fields' => $crud->fields(), 'action' => 'edit'])
		      @else
