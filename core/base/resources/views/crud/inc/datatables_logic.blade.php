 ...
 @endphp
  ...
  <script>
    ...
    $oldAlerts = JSON.parse(localStorage.getItem('bo_alerts'))
        ? JSON.parse(localStorage.getItem('bo_alerts')) : {};

    $newAlerts = @json($bo_alerts);
    ...
    localStorage.setItem('bo_alerts', JSON.stringify($oldAlerts));
    ...
    window.crud = {
      ...
      dataTableConfiguration: {
        ...
        */
        ...
        aaSorting: [],
        language: {
              "emptyTable":     "{{ trans('bo::crud.emptyTable') }}",
              "info":           "{{ trans('bo::crud.info') }}",
              "infoEmpty":      "{{ trans('bo::crud.infoEmpty') }}",
              "infoFiltered":   "{{ trans('bo::crud.infoFiltered') }}",
              "infoPostFix":    "{{ trans('bo::crud.infoPostFix') }}",
              "thousands":      "{{ trans('bo::crud.thousands') }}",
              "lengthMenu":     "{{ trans('bo::crud.lengthMenu') }}",
              "loadingRecords": "{{ trans('bo::crud.loadingRecords') }}",
              "processing":     "<img src='{{ asset('packages/backpack/base/img/spinner.svg') }}' alt='{{ trans('bo::crud.processing') }}'>",
              "search": "_INPUT_",
              "searchPlaceholder": "{{ trans('bo::crud.search') }}...",
              "zeroRecords":    "{{ trans('bo::crud.zeroRecords') }}",
              "paginate": {
                  "first":      "{{ trans('bo::crud.paginate.first') }}",
                  "last":       "{{ trans('bo::crud.paginate.last') }}",
                  "next":       ">",
                  "previous":   "<"
              },
              "aria": {
                  "sortAscending":  "{{ trans('bo::crud.aria.sortAscending') }}",
                  "sortDescending": "{{ trans('bo::crud.aria.sortDescending') }}"
              },
              "buttons": {
                  "copy":   "{{ trans('bo::crud.export.copy') }}",
                  "excel":  "{{ trans('bo::crud.export.excel') }}",
                  "csv":    "{{ trans('bo::crud.export.csv') }}",
                  "pdf":    "{{ trans('bo::crud.export.pdf') }}",
                  "print":  "{{ trans('bo::crud.export.print') }}",
                  "colvis": "{{ trans('bo::crud.export.column_visibility') }}"
              },
          },
          processing: true,
          serverSide: true,
  ...
  <script type="text/javascript">
    jQuery(document).ready(function($) {
      ...
      @if($crud->getOperationSetting('resetButton') ?? true)
        ...
        var crudTableResetButton = '<a href="{{url($crud->route)}}" class="ml-1" id="crudTable_reset_button">{{ trans('bo::crud.reset') }}</a>';
      ...
      $('#crudTable').on('error.dt', function(e, settings, techNote, message) {
          new Noty({
              type: "error",
              text: "<strong>{{ trans('bo::crud.ajax_error_title') }}</strong><br>{{ trans('bo::crud.ajax_error_text') }}"
          }).show();
      });
