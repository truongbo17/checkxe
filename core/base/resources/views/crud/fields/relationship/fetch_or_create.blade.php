...
document.styleSheets[0].addRule('.select2-selection__clear::after','content:  "{{ trans('bo::crud.clear') }}";');
    ...
    $modalSaveButton.on('click', function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                new Noty({
                    type: "info",
                    text: '{{ trans('bo::crud.related_entry_created_success') }}',
                }).show();
            },
            error: function (result) {
                ...
                new Noty({
                    type: "error",
                    text: '<strong>{{ trans('bo::crud.related_entry_created_error') }}</strong><br> '+message,
                }).show();
...
if (typeof processItemText !== 'function') {
    function processItemText(item, $fieldAttribute) {
        ...
        var $emptyTranslation = '{{ trans("bo::crud.empty_translations") }}';
