...
@include('crud::fields.inc.wrapper_start')
	...
	<div class="input-group">
		...
		<span class="input-group-append">
			<button type="button" data-inputid="{{ $field['name'] }}-filemanager" class="btn btn-light btn-sm popup_selector"><i class="la la-cloud-upload"></i> {{ trans('bo::crud.browse_uploads') }}</button>
			<button type="button" data-inputid="{{ $field['name'] }}-filemanager" class="btn btn-light btn-sm clear_elfinder_picker"><i class="la la-eraser"></i> {{ trans('bo::crud.clear') }}</button>
		</span>
	</div>
	@if (isset($field['hint']))
