...
if (file_exists(core_package_path("pagemanager/src/resources/lang/".basename(__DIR__)."/".basename(__FILE__)))) {
    return include core_package_path("pagemanager/src/resources/lang/".basename(__DIR__)."/".basename(__FILE__));
}
