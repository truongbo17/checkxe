...
namespace Dcore\Support\Repositories\Eloquent;

use Bo\Repository\Interfaces\RepositoryInterface;
use Eloquent;
        ...
        if ($params['take'] == 1) {
            ...
            $result = $this->applyBeforeExecuteQuery($data)
                ->$paginateType(
                    ...
                    [$this->originalModel->getTable() . 'Eloquent' . $this->originalModel->getKeyName()],
                    'page',
