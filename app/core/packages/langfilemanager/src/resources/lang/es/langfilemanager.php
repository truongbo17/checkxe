...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Bo\LangFileManager Language Lines
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'rules_text'             => "<strong>Aviso: </strong> No traduzca palabras que empiecen con dos puntos (ej: ':number_of_items'). Esos ser�n reemplazados autom�ticamente con un valor adecuado. Si se traduce, eso deja de funcionar.",
    'saved'                  => 'Guardado',
