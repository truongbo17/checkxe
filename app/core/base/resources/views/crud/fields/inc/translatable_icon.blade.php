...
@endphp
@if ($translatable && config('bo.crud.show_translatable_field_icon'))
    <i class="la la-flag-checkered pull-{{ config('bo.crud.translatable_field_icon_position') }}" style="margin-top: 3px;" title="This field is translatable."></i>
@endif
