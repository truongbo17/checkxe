...
@include('crud::fields.inc.wrapper_start')
    ...
    <input class="array-json"
            ...
            data-max="{{$max}}"
            data-min="{{$min}}"
            data-maxErrorTitle="{{trans('bo::crud.table_cant_add', ['entity' => $item_name])}}"
            data-maxErrorMessage="{{trans('bo::crud.table_max_reached', ['max' => $max])}}">
    ...
    <div class="array-container form-group">
        ...
        <div class="array-controls btn-group m-t-10">
            <button class="btn btn-sm btn-light" type="button" data-button-type="addItem"><i class="la la-plus"></i> {{trans('bo::crud.add')}} {{ $item_name }}</button>
        </div>
