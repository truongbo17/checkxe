...
trait Settings
{
    ...
    public function getOperationSetting(string $key, $operation = null)
    {
        ...
        return $this->get($operation.'.'.$key) ?? config('bo.crud.operations.'.$this->getCurrentOperation().'.'.$key) ?? null;
    }
    ...
    /**
     * Automatically set values in config file (config/bo/crud)
    ...
    public function loadDefaultOperationSettingsFromConfig($configPath = null)
    {
        ...
        $configPath = $configPath ?? 'bo.operations.'.$operation;
