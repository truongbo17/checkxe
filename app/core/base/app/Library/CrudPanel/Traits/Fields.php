...
use Bo\Base\Library\CrudPanel\CrudField;
...
trait Fields
{
     ...
     * Everything else BoCMS can probably guess. This method makes sure  the
    ...
    /**
     * When field is a relationship, BoCMS will try to guess some basic attributes from the relation.
     *
     * @param  array  $field
     * @return array
     */
     ...
     * (once by BoCMS in front-end, once by Laravel Attribute Casting).
     *
     * @param  array  $input
     * @param  mixed  $model
     * @return array
    ...
    public function getStrippedSaveRequest($request)
    {
        ...
        // eg. \App\Http\Requests\BoStrippedRequest
