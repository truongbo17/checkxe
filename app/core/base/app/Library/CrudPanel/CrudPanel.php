...
namespace Bo\Base\Library\CrudPanel;

use Bo\Base\Library\CrudPanel\Traits\Access;
use Bo\Base\Library\CrudPanel\Traits\AutoFocus;
use Bo\Base\Library\CrudPanel\Traits\AutoSet;
use Bo\Base\Library\CrudPanel\Traits\Buttons;
use Bo\Base\Library\CrudPanel\Traits\Columns;
use Bo\Base\Library\CrudPanel\Traits\Create;
use Bo\Base\Library\CrudPanel\Traits\Delete;
use Bo\Base\Library\CrudPanel\Traits\Errors;
use Bo\Base\Library\CrudPanel\Traits\FakeColumns;
use Bo\Base\Library\CrudPanel\Traits\FakeFields;
use Bo\Base\Library\CrudPanel\Traits\Fields;
use Bo\Base\Library\CrudPanel\Traits\Filters;
use Bo\Base\Library\CrudPanel\Traits\HasViewNamespaces;
use Bo\Base\Library\CrudPanel\Traits\HeadingsAndTitles;
use Bo\Base\Library\CrudPanel\Traits\Input;
use Bo\Base\Library\CrudPanel\Traits\Macroable;
use Bo\Base\Library\CrudPanel\Traits\Operations;
use Bo\Base\Library\CrudPanel\Traits\Query;
use Bo\Base\Library\CrudPanel\Traits\Read;
use Bo\Base\Library\CrudPanel\Traits\Relationships;
use Bo\Base\Library\CrudPanel\Traits\Reorder;
use Bo\Base\Library\CrudPanel\Traits\SaveActions;
use Bo\Base\Library\CrudPanel\Traits\Search;
use Bo\Base\Library\CrudPanel\Traits\Settings;
use Bo\Base\Library\CrudPanel\Traits\Tabs;
use Bo\Base\Library\CrudPanel\Traits\Update;
use Bo\Base\Library\CrudPanel\Traits\Validation;
use Bo\Base\Library\CrudPanel\Traits\Views;
use Exception;
...
class CrudPanel
{
     ...
     *
     * DEPRECATION NOTICE: This method is no longer used and will be removed in future versions of BoCMS
     *
     * @deprecated
     *
     * @return bool
     ...
     * - $this->crud->setRoute(config('bo.base.route_prefix').'/article')
     * - $this->crud->setRouteName(config('bo.base.route_prefix').'.article')
     * - $this->crud->route = config('bo.base.route_prefix')."/article"
     *
     * @return string
     */
