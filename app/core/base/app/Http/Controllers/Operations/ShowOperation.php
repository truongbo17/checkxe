...
namespace Bo\Base\Http\Controllers\Operations;
...
trait ShowOperation
{
    ...
    protected function setupShowDefaults()
    {
        ...
        $this->crud->operation(['create', 'update'], function () {
            $this->crud->addSaveAction([
                ...
                'button_text' => trans('bo::crud.save_action_save_and_preview'),
            ]);
        });
    }
    ...
    public function show($id)
    {
        ...
        $this->data['title'] = $this->crud->getTitle() ?? trans('bo::crud.preview').' '.$this->crud->entity_name;

        // load the view from /resources/views/vendor/bo/crud/ if it exists, otherwise load the one in the package
