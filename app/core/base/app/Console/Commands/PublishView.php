...
class PublishView extends Command
{
     ...
     * @var string
     */
    protected $signature = 'bo:cms:publish
     ...
     * @var string
     */
    protected $description = 'Publishes a BoCMS view so you can make changes to it, for your project.';
     ...
     * @var string
     */
    public $sourcePath = 'core/base/resources/views/';
     ...
     * @var string
     */
    public $destinationPath = 'resources/views/vendor/bo/';
