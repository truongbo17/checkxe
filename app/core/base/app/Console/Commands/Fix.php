...
class Fix extends Command
{
     ...
     * @var string
     */
    protected $signature = 'bo:cms:fix';
     ...
     * @var string
     */
    protected $description = 'Fix known BoCMS issues.';
    ...
    private function fixErrorViews()
    {
        ...
        foreach ($views as $key => $view) {
            ...
            $new_contents = str_replace('$exception->getMessage()?$exception->getMessage():$default_error_message',
                '$exception->getMessage()?e($exception->getMessage()):$default_error_message', $contents);
